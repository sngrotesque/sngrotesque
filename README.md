...
我是一个[开发者](https://github.com/sngrotesque)，也是一个[音乐人](https://music.163.com/#/artist?id=30774062)，同时也是一个[视频制作者](https://space.bilibili.com/27958784)，当然也是一个游戏玩家，目前只玩[明日方舟 - Arknights](https://ak.hypergryph.com/)、[卡拉彼丘 - CalabiYau](https://klbq.qq.com/web202305/index.html?nav=home)、[蔚蓝档案 - Blue Archive](https://bluearchive-cn.com/)、[CS2](https://store.steampowered.com/app/730/CounterStrike_2/)，[公主连结 - プリンセスコネクト！Re:Dive](https://game.bilibili.com/pcr/)。  
...
对于[Python](https://www.python.org/)的版本，我使用[Python 3.11.9](https://www.python.org/downloads/release/python-3119/)作为开发版本于生产版本，以往使用[Python 3.7.5](https://www.python.org/downloads/release/python-375/)进行开发。  
我喜欢研究很多东西，包括计算机底层的各种技术和算法实现，渴望使用最短代码做到最高水准。  

# Projects
 -  [The wizard's universal key](https://github.com/sngrotesque/wizard_key)，这是我主力开发的[C++](https://en.wikipedia.org/wiki/C%2B%2B)库，用于未来我的[即时通讯软件](https://en.wikipedia.org/wiki/Instant_messaging)的底层，可以理解为一个为了支持未来软件而开发的框架，比肩甚至超过[Telegram](https://telegram.org/)与[WhatsAPP](https://www.whatsapp.com/)，将致力于为各位提供一个轻量易用可自定义且无广告的即时通讯软件；这个框架也将会用于未来游戏开发时使用。
...
<a href="https://stackoverflow.com/users/21376217/s-n"><img src="https://stackoverflow.com/users/flair/21376217.png?theme=hotdog" width="208" height="58" alt="profile for S-N at Stack Overflow, Q&amp;A for professional and enthusiast programmers" title="profile for S-N at Stack Overflow, Q&amp;A for professional and enthusiast programmers" align="right"></a>
 ...
 - [苏茜·格里特理发店](https://x.com/CNSN_W)，这是我多个Twitter账号的其中一个。
...
如果你要与我合作开发代码，下面是我的代码风格，这是我的[C++代码开发规范](https://github.com/sngrotesque/wizard_key?tab=readme-ov-file#%E5%BC%80%E5%8F%91%E8%A7%84%E8%8C%83development-specifications)，你可以参考一下自己是否能够接受。  
